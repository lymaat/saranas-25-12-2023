...
const product = (app,route_name) =>{
    ...
    app.post(`${route_name}`,upload.single("image_upload"),userGuard("product.Create"),ct.create)
    app.put(`${route_name}`,upload.single("image_upload"),userGuard("product.Update"),ct.update)
